...
BOOKS = [
    ...
    },
    {
        ...
        "category": "经典名著",
        "coverColor": "#CD853F",
        "intro": "《骆驼祥子》是老舍的代表作，以20世纪20年代的北京为背景，讲述了一个洋车夫祥子的故事。祥子老实、健壮、坚忍，最大的梦想不过是拥有一辆自己的车。但在那个黑暗世道里，他的希望一次又一次破灭，最终沦为行尸走肉。小说深刻揭露了旧中国的黑暗，表达了对劳动人民的深切同情。",
    },
    {
        "title": "红高粱",
        "author": "莫言",
...
def main():
    ...
    for i, book in enumerate(BOOKS, 1):
        ...
        try:
            ...
            if not quotes:
                quotes = [
                    {"content": f"这是《{book['title']}》中的一句经典台词。", "author": book["author"]},
                    {"content": "人生若只如初见，何事秋风悲画扇。", "author": book["author"]},
                ]
